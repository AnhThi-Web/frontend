                ...
                <div className="mb-10">
                  ...
                  <ul className="space-y-1">
                    <li>
                      ...
                      >
                        <span className="text-sm font-oswald uppercase tracking-wide">Tất cả sản phẩm</span>
                        <ChevronRight size={16} className={cn(
                          "transition-transform",
                          selectedCategory === "all" ? "translate-x-1" : "opacity-0 group-hover:opacity-100"
                        )} />
                      </Link>
                    </li>
                    {categories.map((cat) => (
                  ...
                  {filteredProducts.map((product) => (
                    ...
                    >
                      ...
                      <div className="p-6 flex-grow flex flex-col justify-between">
                        ...
                        <Link href={`/${product.slug}`} className="text-sm font-bold text-primary flex items-center gap-2 hover:gap-3 transition-all">
